...
public interface PluginIcons {
    ...
    Icon REFRESH_SUSI = IconLoader.getIcon("/icons/refresh.png");
    ...
    Icon SOURCE = IconLoader.getIcon("/icons/source.png");
    Icon SANITIZER = IconLoader.getIcon("/icons/sanitizer.png");
    Icon SINK = IconLoader.getIcon("/icons/sink.png");
    Icon AUTHENTICATION = IconLoader.getIcon("/icons/authentication.png");
    Icon CWE = IconLoader.getIcon("/icons/cwe.png");
    Icon OTHER = IconLoader.getIcon("/icons/cwe.png");
