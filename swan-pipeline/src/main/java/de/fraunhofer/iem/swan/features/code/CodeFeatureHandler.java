...
public class CodeFeatureHandler {
    ...
    public void initializeFeatures() {
        ...
        // Method modifier.
        IFeature isStaticMethod = new MethodModifierFeature(Modifier.STATIC);
        ...
        IFeature isPublicMethod = new MethodModifierFeature(Modifier.PUBLIC);
        ...
        IFeature isPrivateMethod = new MethodModifierFeature(Modifier.PRIVATE);
        ((WeightedFeature) isPrivateMethod).setWeight(10);
        addFeature(isPrivateMethod, new HashSet<>(
                Arrays.asList(Category.SOURCE, Category.SINK, Category.NONE, Category.RELEVANT)));

        IFeature isFinalMethod = new MethodModifierFeature(Modifier.FINAL);
