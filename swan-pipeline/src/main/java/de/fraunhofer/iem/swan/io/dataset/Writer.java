...
//                continue;
            ...
            obj.put(Constants.JAVADOC, method.getJavadoc());
            obj.put(Constants.SOURCE_JAR, method.getSourceJar());
            ...
            JSONObject javadoc = new JSONObject();
            javadoc.put(Constants.CLASS_DOC, method.getJavadoc().getClassComment());
            javadoc.put(Constants.METHOD_DOC, method.getJavadoc().getMethodComment());
            obj.put(Constants.JAVADOC, javadoc);
