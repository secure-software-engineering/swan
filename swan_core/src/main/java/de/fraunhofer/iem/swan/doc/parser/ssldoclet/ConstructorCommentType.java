...
/**
 * <p>Java-Klasse für Constructor_CommentType complex type.
 * 
 * <p>Das folgende Schemafragment gibt den erwarteten Content an, der in dieser Klasse enthalten ist.
 * 
 * <pre>
 * &lt;complexType name="Constructor_CommentType">
 *   &lt;simpleContent>
...
@XmlType(name = "Constructor_CommentType", propOrder = {
    "value"
})
public class ConstructorCommentType {
