...
import de.fraunhofer.iem.swan.doc.parser.DocletExecutor;
...
public class Training {
    ...
    public static void main(String[] args) throws IOException {
        ...
        parser.parse("/Users/oshando/Projects/thesis/03-code/src/main/resources/training-set-original.json");
        ...
        try {
            lines = new HashSet<>(FileUtils.readLines(new File(" /Users/oshando/Projects/thesis/03-code/src/main/resources/thecodemaster-methods.txt"), Charset.defaultCharset().toString()));
        } catch (IOException e) {
            e.printStackTrace();
        }
        ...
        String input = "/Users/oshando/Projects/thesis/03-code/src/main/resources/jars";
        String output = "/Users/oshando/Projects/thesis/03-code/javadoc";
...
//                        );
              ...
              //  String rootPackages = StringUtils.join(Main.getRootPackages(packages), ":");
                ...
                String sourcePath = "/Users/oshando/Projects/thesis/03-code/src/main/resources/jars/rt/";
