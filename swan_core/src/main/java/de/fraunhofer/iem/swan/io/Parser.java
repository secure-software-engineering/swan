...
import de.fraunhofer.iem.swan.data.*;
...
import de.fraunhofer.iem.swan.features.type.IFeature.Type;
...
public class Parser {
    ...
    public void loadMethods(Set<String> trainingSetFiles) throws IOException {
        ...
        logger.info("Collected {} methods from the training set.", methods.size());
    }
    ...
    public void removeUndocumentedMethods(){
        Set<Method> temp = new HashSet<>(methods);
    ...
    private void loadMethodsFromJsonArray(JSONArray array, String type) {
        ...
        if (type.equals("methods")) {
            ...
            while (iterator.hasNext()) {
                ...
                String sourceJar = (String) jsonObj.get(Constants.SOURCE_JAR);

                JSONObject javadoc = (JSONObject) jsonObj.get(Constants.JAVADOC);
                ...
                if (javadoc != null) {
                    ...
                    Javadoc javadocComment = new Javadoc();
                    javadocComment.setMethodComment(javadoc.get(Constants.METHOD_DOC).toString());
                    javadocComment.setClassComment(javadoc.get(Constants.CLASS_DOC).toString());
                    m.setJavadoc(javadocComment);
                }
