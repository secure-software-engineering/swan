 ...
 * generated in the de.fraunhofer.iem.swan.doc.parser.ssldoclet package.
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: de.fraunhofer.iem.swan.doc.parser.ssldoclet
     * 
     */
